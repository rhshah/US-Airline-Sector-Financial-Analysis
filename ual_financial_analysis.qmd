...
```{r, include=FALSE}
#| label: ual-asset-turnover
#| fig.cap: "United Airlines (UAL) Quarterly Total Asset Turnover (2020-2024)"
#| echo: false
#| message: false
#| warning: false
ggthemr("flat")
p9 <- ggplot() +
  ...
  labs(
    x = "Year & Quarter", y = NULL, color = NULL,
    title = "Total Asset Turnover for UAL (2020 Q1 - 2025 Q2)"
  ) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
```{r, include=FALSE}
#| label: ual-profit-margin
#| fig.cap: "United Airlines (UAL) Quarterly Profit Margin Ratio (2020-2024)"
#| echo: false
#| message: false
#| warning: false
ggthemr("flat")
p10 <- ggplot() +
  ...
  labs(
    x = "Year & Quarter", y = NULL, color = NULL,
    title = "Profit Margin Ratio for UAL (2020 Q1 - 2025 Q2)"
  ) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
```{r}
#| label: ual-roa-decomposition
#| echo: false
#| message: false
#| warning: false
#| fig-cap: United Airlines (UAL) Quarterly ROA Decomposition (2020-2024)
#| fig-height: 12
#| fig-width: 15
ggthemr("flat")
ual_roa_decomposition <- (p9 + p10) / p7 + 
  plot_annotation(
    title = "ROA Decomposition for UAL (2020 Q1 - 2025 Q2)",
    caption = "ROA = Total Asset Turnover × Profit Margin"
  )
ual_roa_decomposition
...
```{r, include=FALSE}
#| label: ual-capital-structure-leverage
#| fig.cap: "United Airlines (UAL) Quarterly Capital Structure Leverage Ratio (2020-2024)"
#| echo: false
#| message: false
#| warning: false
ggthemr("flat")
p11 <- ggplot() +
  ...
  labs(
    x = "Year & Quarter", y = NULL, color = NULL,
    title = "Capital Structure Leverage Ratio for UAL (2020 Q1 - 2025 Q2)"
  ) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
```{r, include=FALSE}
#| label: ual-common-earnings-leverage
#| fig.cap: "United Airlines (UAL) Quarterly Common Earnings Leverage Ratio (2020-2024)"
#| echo: false
#| message: false
#| warning: false
ggthemr("flat")
p12 <- ggplot() +
  ...
  labs(
    x = "Year & Quarter", y = NULL, color = NULL,
    title = "Common Earnings Leverage Ratio for UAL (2020 Q1 - 2025 Q2)"
  ) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
```{r}
#| label: ual-roe-decomposition
#| fig.cap: "United Airlines (UAL) Quarterly ROE Decomposition (2020-2024)"
#| echo: false
#| message: false
#| warning: false
#| fig-height: 12
#| fig-width: 20
ggthemr("flat")
ual_roe_decomposition <- (p7 + p11 + p12) / p8 + 
  plot_annotation(
    title = "ROE Decomposition for UAL (2020 Q1 - 2025 Q2)",
    caption = "ROE = ROA × Capital Structure Leverage × Common Earnings Leverage"
  )
ual_roe_decomposition
```
:::
